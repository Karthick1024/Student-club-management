...
const NewRegistration = ({ setShowStudentRegistration }) => {
  ...
  return (
    <div className="student-form ">
      <div className="register w-100 card-2 shadow-lg p-4">
        ...
        <div className="grouping d-flex justify-content-evenly">
          <form onSubmit={handleSubmit} className="student-form-fill mt-5  w-75">
            <div className="row-1">
          ...
          <div className="side-img mt-5">
            <img src={bg} height='600px' width='200px' alt="" />
          </div>
        </div>
      </div >
    </div >
